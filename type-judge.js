...
const TYPES = {
  "革新_広い_リーダー_楽天":  { name:"ヒーロー",          desc:"前線で人を巻き込み、新しい時代を作るリーダー",
    ...
    story: "幼い頃から「自分が動けば何かが変わる」という感覚を持つ。学校でも自然とリーダー役を引き受け、周囲を巻き込んで何かを始める。失敗しても立ち上がる回復力があり、20代で早くも自分の道を見つける。壮年期は人を率いて大きなプロジェクトを動かし、「この人についていけば大丈夫」と思わせる存在になる。",
    struggles: "常に先頭に立つプレッシャーで疲弊する。弱さを見せられず、一人で抱え込む。周囲が自分のペースについてこれないことへの苛立ち。「自分がやった方が早い」と思って任せられず、結果的にチームが育たない。",
    remedies: "月に1回は「何もしない日」を作る。弱さを見せられる相手を1人確保する。「任せる」を意識的に練習し、70%の出来でもOKを出す。走り続けるのではなく、立ち止まって振り返る時間を持つ。",
  },
  "革新_広い_リーダー_慎重":  { name:"レボリューショナリー", desc:"深く考え、世を変えるしかないと突き進む",
    paradox:"穏やかに見えるのに、内側で世界を壊そうとしている人。",
    ...
    story: "若い頃から「おかしい」と感じることに黙っていられない。最初は周囲と衝突するが、やがて同じ志を持つ仲間と出会い、変革の道を歩み始める。30代で「自分が変えなければ誰が変える」という覚悟が固まる。壮年期は長い戦いの中で少しずつ成果を出し、晩年に「あの人がいなければ今はなかった」と言われる存在になる。",
    struggles: "理想が高すぎて現実との折り合いがつかない。味方と敵を分けすぎて孤立する。「正しいことをしているのになぜ理解されない」という苦しみ。長期戦で心身が消耗し、燃え尽きるリスクが常にある。",
    remedies: "「100%の変革」ではなく「1%の改善」を積み重ねる視点を持つ。敵だと思っている人の中にも味方がいることを忘れない。定期的に自然の中で過ごし、戦闘モードを解除する時間を作る。",
  },
  "革新_広い_参謀_楽天":      { name:"トリックスター",    desc:"場に化学反応を起こす陽気な触媒",
    paradox:"軽く振る舞うのに、誰よりも鋭く場を見ている人。",
    ...
    story: "子供の頃から「場を盛り上げる子」として知られる。退屈が最大の敵で、常に新しい刺激を求めて動き回る。20代は多くのことに手を出し、器用貧乏と言われることも。しかし30代以降、「場に化学反応を起こす」という自分だけの価値に気づき、それを武器にする。人と人を繋ぎ、予想外の組み合わせから新しいものを生む触媒として活躍する。",
    struggles: "軽く見られて本気で取り合ってもらえない。深い話をしたいのに、周囲が「いつもの冗談」と受け取る。飽きっぽさで中途半端に終わるプロジェクトが多い。「面白い人」止まりで、信頼される存在になりにくい。",
    remedies: "一つだけ「最後までやり切る」プロジェクトを持つ。真剣な場面では意識的にトーンを変える。「面白い」と「信頼できる」は両立できることを行動で示す。深い関係を3人だけ作り、そこでは素の自分を見せる。",
  },
  "革新_広い_参謀_慎重":      { name:"ヴィジョナリー",    desc:"未来を見通し、独自の視点で組織を動かす",
    paradox:"先が見えているのに、今ここでうまく伝えられない人。",
    ...
    story: "幼い頃から「なぜ？」が止まらない子供。周囲が当たり前と思うことに疑問を持ち、独自の理論を組み立てる。学生時代は「頭はいいけど何を考えているかわからない」と言われる。30代で自分のビジョンが形になり始め、「あの人の言っていたことはこういう意味だったのか」と周囲が追いつく。壮年期は静かに組織を動かす参謀として、大きな変革の設計図を描く。",
    struggles: "考えが先に行きすぎて、今の現実との接点を失う。「正しいことを言っているのに伝わらない」というもどかしさ。感情より論理で動くため、冷たい人だと誤解される。孤独な思考の時間が長く、人間関係が希薄になりがち。",
    remedies: "ビジョンを「3行で説明する」練習をする。相手の感情に先に触れてから論理を展開する。週に1回は「考えない時間」を作り、体を動かす。信頼できる翻訳者（自分の考えを人に伝えてくれる人）を見つける。",
  },
  "革新_狭い_リーダー_楽天":  { name:"パイオニア",        desc:"自分の領域を切り拓く先駆者",
    paradox:"切り拓くのは得意なのに、続けることが苦手な人。",
    ...
    story: "子供の頃から「一番乗り」が好き。誰もやっていないことに飛び込む勇気があり、失敗を恐れない。20代で早くも自分の道を切り拓き始め、周囲が「無謀だ」と言う中で結果を出す。壮年期は自分が開拓した領域で第一人者となり、後から来る人たちの道標になる。",
    struggles: "開拓は得意だが、維持・管理が苦手。始めたことを途中で投げ出してしまう。チームで動くより一人で突っ走りたいので、組織の中で浮く。「自分がやりたいこと」と「組織が求めること」のギャップに苦しむ。",
    remedies: "「開拓フェーズ」と「運用フェーズ」を明確に分け、運用は人に任せる。一人で突っ走る前に「誰か一人だけ巻き込む」習慣を持つ。飽きたら次に行っていい、ただし引き継ぎだけはする。",
  },
  "革新_狭い_リーダー_慎重":  { name:"ローンウルフ",      desc:"信念だけで戦う孤独な戦士",
    paradox:"人を率いる力があるのに、誰にも寄りかからない人。",
    ...
    story: "幼い頃から「自分は自分」という感覚が強い。集団に合わせることを拒み、孤立することも厭わない。20代で組織の理不尽さに直面し、「自分の力だけで生きる」と決意する。30代以降は独立した立場で、自分の信念に基づいて戦い続ける。周囲からは「怖い人」と思われることもあるが、信頼した相手には深い忠誠を見せる。",
    struggles: "孤独が長すぎて心が枯れる。助けを求められない。「自分でやるしかない」と思い込み、限界まで一人で抱える。信頼できる人が極端に少なく、裏切られた経験がトラウマになっている。感情を表に出せず、誤解されやすい。",
    remedies: "「助けを求めることは弱さではない」と自分に言い聞かせる。信頼できる人を1人だけ見つけ、定期的に話す。体を動かすことで溜まった感情を発散する。完全な孤独ではなく「選んだ少数との繋がり」を維持する。",
  },
  "革新_狭い_参謀_楽天":      { name:"シーカー",          desc:"好きなことだけを楽しく深く究める",
    paradox:"柔らかく見えるのに、譲れない一点では誰より頑固な人。",
    ...
    story: "子供の頃から一つのことに没頭する。図鑑を端から端まで読み、誰も聞いていないのに延々と語る。学校では「変わった子」だが、本人は幸せ。20代は好きなことと仕事の折り合いに悩むが、30代で「好きなことで生きる」道を見つける。壮年期は自分の領域で唯一無二の存在になり、同じ趣味の仲間と深い繋がりを持つ。",
    struggles: "興味のないことが全くできない。社会的な義務（書類、手続き、挨拶回り）が苦痛。好きなことに没頭しすぎて生活が崩れる。「いつまでも子供みたい」と言われて傷つく。収入が不安定になりやすい。",
    remedies: "「好きなこと」と「生活を支えること」を完全に分けず、接点を探す。苦手な事務作業は仕組み化するか人に頼む。没頭する時間と生活の時間を明確に区切る。同じ趣味の仲間を大切にする（理解者がいると安定する）。",
  },
  "革新_狭い_参謀_慎重":      { name:"マーベリック",    desc:"群れを離れ、自分の領域で革命を起こす者",
    paradox:"社交的に見えるのに、本当は一人で深く考えている人。",
    ...
    story: "幼い頃から「みんなと同じ」に違和感を覚える。集団の中にいても、心のどこかで外側から眺めている自分がいる。やがて一つの領域に没頭し始め、誰にも教わらず独自の方法論を築いていく。周囲からは「変わっている」と言われるが、本人にとってはそれが自然体。30代以降、自分の専門性が社会と接続する瞬間が訪れ、「群れなくても価値を生める」という確信を得る。晩年は少数の理解者に囲まれ、自分の領域で静かに革命を続ける。",
    struggles: "一人が好きなのに、ふとした瞬間に孤独を感じる。理解者が少なく、自分の考えを共有できる相手を見つけるのに時間がかかる。完璧主義で「まだ足りない」と感じ続け、なかなか世に出せない。慎重さが裏目に出て、チャンスを逃すことがある。組織の中では「協調性がない」と評価されやすく、本当の実力が伝わりにくい。",
    remedies: "理解者は1人いれば十分。その1人を大切にする。完成度70%で出す練習を意識的にする。「まだ早い」と感じた時が実はちょうどいいタイミング。定期的に人と会う予定を入れる（自分からは動かないので仕組み化する）。自分の専門を言語化して発信する習慣を持つと、理解者が向こうから来る。",
  },
  "継承_広い_リーダー_楽天":  { name:"ソブリン",          desc:"光で人を集め、伝統を継ぐカリスマ",
    paradox:"明るく磊落に見えるのに、内側に重い責任を抱えている人。",
    ...
    story: "生まれながらに「継ぐべきもの」がある環境で育つ。若い頃は自由に憧れるが、やがて自分の役割を受け入れ、伝統に新しい光を当てる道を選ぶ。壮年期は明るさとカリスマで人を集め、古いものを時代に合わせて発展させる。晩年は「あの人がいたから続いた」と言われる存在になる。",
    struggles: "自由に生きたい気持ちと「継がなければ」という責任の板挟み。自分の意志なのか、周囲の期待なのか分からなくなる。明るく振る舞う裏で、重圧に押しつぶされそうになる。「自分らしさ」と「役割」の間で揺れる。",
    remedies: "「継ぐ」と「自分らしく」は両立できると信じる。伝統の中に自分なりの解釈を入れる余地を見つける。重圧を感じたら、同じ立場の人（二代目仲間など）と話す。完全に役割から離れる時間を定期的に作る。",
  },
  "継承_広い_リーダー_慎重":  { name:"エンペラー",        desc:"重責を担い、組織を率いる威厳の人",
    paradox:"組織を束ねる威厳があるのに、本心は誰にも読ませない人。",
    ...
    story: "若い頃から「責任を取る」ことを自然に引き受ける。組織の中で着実に信頼を積み上げ、40代以降にトップの座に就く。派手さはないが、危機の時に真価を発揮する。「この人がいれば大丈夫」という安心感を周囲に与え、大きな組織を安定させる。晩年は後継者を育て、静かに退く。",
    struggles: "決断が遅いと批判される。慎重すぎて変化のスピードに追いつけない。重責を一人で背負い、孤独を感じる。「もっと早く動けば」という後悔が多い。部下に弱さを見せられず、相談相手がいない。",
    remedies: "「決断しないことも決断」と割り切らず、期限を決めて動く。信頼できる参謀を1人確保し、本音を話す。完璧な判断を求めず、「今の情報で最善」を選ぶ。体を動かすことでストレスを発散する。",
  },
  "継承_広い_参謀_楽天":      { name:"セージ",            desc:"楽しみながら教え、人を育てる賢者",
    paradox:"人に教え続けるのに、自分が学ぶ時間を後回しにする人。",
    ...
    story: "子供の頃から「教える」のが好き。友達に勉強を教えたり、年下の面倒を見たりする。学ぶことと教えることが一体化しており、知識を独り占めしない。30代で「人を育てる」ことが自分の天職だと気づく。壮年期は多くの人に影響を与え、「あの人に出会えてよかった」と言われる存在になる。",
    struggles: "教えすぎて相手の自立を妨げてしまう。「いい人」でいようとして本音を言えない。八方美人になり、自分の意見が曖昧になる。人に尽くしすぎて自分の時間がなくなる。「先生」として見られることで対等な関係が作りにくい。",
    remedies: "「教えない」ことも教育だと知る。相手が自分で気づくまで待つ練習をする。「NO」を言う練習を意識的にする。自分自身が学ぶ時間を確保する（教える側だけでいると枯れる）。",
  },
  "継承_広い_参謀_慎重":      { name:"オラクル",          desc:"重みのある言葉で人を導く知の人",
    paradox:"深い影響力があるのに、自分からはほとんど語らない人。",
    ...
    story: "若い頃は寡黙で目立たない。しかし内側では膨大な量の観察と思考を重ねている。30代で「この人の言葉には重みがある」と気づかれ始め、40代以降に本格的に頼られる存在になる。多くを語らないが、一言が場の方向を変える。晩年は「知恵の人」として少数の人に深い影響を与え続ける。",
    struggles: "若い頃は「何を考えているかわからない」と距離を置かれる。自分の考えを伝えるタイミングを逃す。重い言葉を出しすぎて場を固めてしまう。「もっと早く言ってくれれば」と言われることが多い。晩成型ゆえに、若い時期の評価が低く苦しむ。",
    remedies: "「完璧な答え」を待たず、途中経過でも共有する習慣を持つ。軽い雑談の中に自分の考えを混ぜる練習をする。若い時期は「まだ途中」と割り切り、焦らない。書くことで思考を外に出す（話すより書く方が得意なはず）。",
  },
  "継承_狭い_リーダー_楽天":  { name:"アルチザン",        desc:"自分の道を究め、後進に伝える名工",
    paradox:"気さくに教えるのに、自分の技には一切妥協しない人。",
    ...
    story: "幼い頃から手を動かすのが好き。何かを作ること、直すこと、磨くことに喜びを感じる。20代で師匠に出会い、技を学び始める。30代で自分のスタイルが確立し、40代以降は後進に技を伝える立場になる。「この人の手から生まれたもの」に価値がある、と認められる職人になる。",
    struggles: "技術の価値が正当に評価されない社会への不満。効率化・デジタル化の波に取り残される不安。弟子が育たない、または後継者がいない焦り。「もっと上手くなりたい」という終わりのない向上心が自分を追い詰める。",
    remedies: "技術の価値を言語化して発信する（SNS、ブログ、動画）。「完璧」ではなく「今の最善」で世に出す。後継者は「自分のコピー」ではなく「自分を超える人」を育てる意識で。異分野の人と交流し、視野を広げる。",
  },
  "継承_狭い_リーダー_慎重":  { name:"ガーディアン",      desc:"重い使命を背負って伝統を守る守護者",
    paradox:"守るためなら強くなれるのに、自分のことは後回しにする人。",
    ...
    story: "幼い頃から「守るべきもの」に対する強い意識がある。家族、地域、伝統、組織――何かを守ることに使命感を感じる。20代で自分が守るべき対象を見つけ、そこに人生を捧げる覚悟を決める。壮年期は黙々と守り続け、危機の時に真価を発揮する。晩年は「あの人がいたから残った」と言われる。",
    struggles: "変化を受け入れられず、時代に取り残される恐怖。守ることに固執しすぎて、新しい可能性を潰してしまう。寡黙さが冷たさと誤解される。「なぜ自分だけが守らなければならないのか」という孤独感。報われない努力が続く。",
    remedies: "「守る」と「変える」は対立しないことを知る。守りながら少しずつ更新する方法を探す。感謝の言葉を待たず、自分で自分を認める。同じ志を持つ仲間と定期的に会い、孤独を解消する。",
  },
  "継承_狭い_参謀_楽天":      { name:"ケアテイカー",      desc:"黙々と支え、人を育てる縁の下の力持ち",
    paradox:"人の変化には細やかに気づくのに、自分の欲求には鈍い人。",
    ...
    story: "幼い頃から人の世話を焼くのが自然。困っている人を放っておけず、自分のことより人のことを優先する。20代は「便利な人」として使われることもあるが、30代で「支えることの価値」を自覚する。壮年期は多くの人の成長を裏から支え、「あの人がいなければ今の自分はない」と感謝される存在になる。",
    struggles: "自分を後回しにしすぎて疲弊する。「NO」が言えず、頼まれると断れない。自分の欲求が何なのか分からなくなる。過小評価され、昇進や評価の機会を逃す。「いい人」止まりで、自分の人生を生きている実感がない。",
    remedies: "「自分を満たすことは、人を支える力の源泉」と理解する。週に1回は自分だけの時間を確保する。「NO」を言う練習を小さなことから始める。自分の功績を記録し、可視化する（他人は気づかないので自分で示す）。",
  },
  "継承_狭い_参謀_慎重":      { name:"ハーミット",        desc:"世から離れ、深く一点を究める静かな賢者",
    paradox:"世から離れているのに、その仕事が誰より遠くまで届く人。",
    ...
    story: "幼い頃から一人の時間を好む。騒がしい場所より静かな場所、大勢より一人。内面の世界が豊かで、外の世界に出る必要性をあまり感じない。20代は社会との折り合いに苦労するが、30代で「自分のペースで深く究める」生き方を確立する。壮年期は少数の理解者に囲まれ、静かに深い仕事を続ける。晩年に「あの人の仕事は時代を超えている」と評価される。",
    struggles: "社会との接点が少なすぎて孤立する。生活力が低く、日常の雑事に圧倒される。人間関係の維持コストが払えず、気づくと誰もいない。「世間」の価値観と自分の価値観のギャップに苦しむ。成果が出るまでに時間がかかりすぎて、途中で心が折れる。",
    remedies: "完全な孤独ではなく「週1回だけ人と会う」仕組みを作る。生活の最低限（食事・睡眠・運動）を仕組み化する。自分の仕事を「誰か1人に見せる」習慣を持つ（完全に閉じると枯れる）。「世間の評価」ではなく「自分の基準」で進捗を測る。",
  },
};
