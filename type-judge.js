...
const TYPES = {
  ...
  "革新_狭い_参謀_慎重":      { name:"マーベリック",    desc:"群れを離れ、自分の領域で革命を起こす者",
    etymology: "英語 Maverick = 群れから離れた子牛。19世紀テキサスの牧場主サミュエル・マーベリックが、他の牧場主と違い牛に焼印を押さなかったことに由来する。理由は諸説あり「動物を傷つけたくなかった」とも「面倒だった」とも言われるが、結果として焼印のない牛は全て『マーベリックの牛』と呼ばれるようになった。皮肉にも、印を付けないことが最大の印になった。やがて転じて「組織に属さない独立した個人」「群れから外れた一匹狼」を指す言葉に。政治では党の方針に従わない議員を、映画『トップガン』では孤独な天才パイロットを指す。作中で「親に嫌われたのか？」と聞かれる場面があるように、この言葉には「自ら選んだ孤独」と「周囲から押し付けられた孤立」の両面が含まれている。",
